...
import { SidebarLink } from '../../../layouts/Link'

const Menu = ({ item, handleSelected, selected }) => {
			...
			{subnav &&
				item.subNav.map((s) => {
					return (
						<SidebarLink
							tabIndex="-1"
							className={`flex group items-center w-full text-sm hover:text-buttonPrimary cursor-pointer hover:border-r-4 hover:border-buttonPrimary ${
